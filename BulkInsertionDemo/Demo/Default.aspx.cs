...
namespace Demo
{
    public partial class _Default : Page
    {
        ...
        public void connection()
        {
           ...
           // String str = "database=ProductDetails; initial catalog=CRIBV-DNET23; intergrated security=true";
        ...
        private void AddNewRecordRowToGrid()
        {
            ...
            {
                DataTable dtCurrentTable = (DataTable)ViewState["Details"];
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    ...
                    ViewState["Details"] = dtCurrentTable;
        ...
        {
            DataTable dtProductSold = (DataTable)ViewState["Details"];
            connection();
            ...
            objbulk.ColumnMappings.Add("Warrenty", "Warranty");
